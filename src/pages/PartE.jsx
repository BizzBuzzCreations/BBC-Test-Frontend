...
const PartE = () => {
  ...
  const questions = [
    ...
    {
      id: 1,
      question: "A customer says, “I don’t need this product.” What would you say to convince them?",
      options: [
        "change the product?",
    ...
    {
      id: 2,
      question: "If a customer buys a phone, and you suggest earphones and a phone cover, what is this called?",
      options: ["Upselling","Advertising","Cross-selling","Branding"]
    },

    {
      id: 3,
      question: "A salesperson makes 50 calls and gets 13 sales. What is the conversion rate?",
      options: ["26%", "21.5%", "19%", "23%"]
    },

    {
      id: 4,
      question: "If a person earns ₹27,500 per month and works 7 hours per day, how much does the person earn per hour in the month of February",
      options: ["₹150.20", "₹145.30", "₹130.10", "₹155.20"]
    },

    {
      id: 5,
      question: "A salesperson suggests a more expensive version of the product that has better features. This technique is called:",
                ...
                {q.options.map((option, i) => (
                  ...
                  <label
                    ...
                    className={`block border p-3 rounded-lg cursor-pointer ${
                      answers[q.id] === option ? "bg-blue-100 border-blue-400" : ""
